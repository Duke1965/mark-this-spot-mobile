...
export const CanvasEditor = forwardRef<HTMLCanvasElement, CanvasEditorProps>(
  ({ mediaUrl, mediaType, locationName, platform, onBack, onSave, onClose, onDataChange }, ref) => {
    ...
    // Text editing states
    const [newText, setNewText] = useState(`📍 ${locationName}`)
    ...
    }, [textElements, stickerElements, currentEffect, mediaUrl, videoSettings])
