...
import type { PinData, GooglePlace, Recommendation } from '@/lib/types'
    ...
    return (
      <ContentEditor
        ...
        onPost={(contentData) => {
          ...
          if (isPosting) {
            console.log("🎯 Already posting, returning")
            return
          }
          setIsPosting(true)
          ...
          console.log("🎯 Set currentScreen to recommendation-form")
          setIsPosting(false)
          console.log("🎯 Set isPosting to false - END")
        }}
        onSave={(contentData) => {
