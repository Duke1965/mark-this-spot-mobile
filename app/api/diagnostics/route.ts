...
export async function GET(request: NextRequest) {
  ...
  diagnostics.environment = {
    ...
    NEXT_PUBLIC_USE_GOOGLE_PIN_INTEL: process.env.NEXT_PUBLIC_USE_GOOGLE_PIN_INTEL || undefined,
    GOOGLE_MAPS_API_KEY: !!process.env.GOOGLE_MAPS_API_KEY,
    PINIT_ENABLE_GOOGLE_CACHE: process.env.PINIT_ENABLE_GOOGLE_CACHE || undefined,
    PINIT_GOOGLE_CACHE_TTL_DAYS: process.env.PINIT_GOOGLE_CACHE_TTL_DAYS || undefined,
    GOOGLE_ENABLE_PHOTOS: process.env.GOOGLE_ENABLE_PHOTOS || undefined,
    GOOGLE_MAX_PHOTOS: process.env.GOOGLE_MAX_PHOTOS || undefined,
    GOOGLE_PIN_INTEL_MAX_DISTANCE_METERS: process.env.GOOGLE_PIN_INTEL_MAX_DISTANCE_METERS || undefined,
    GOOGLE_PIN_INTEL_MAX_DISTANCE_METERS_CHAIN: process.env.GOOGLE_PIN_INTEL_MAX_DISTANCE_METERS_CHAIN || undefined,
